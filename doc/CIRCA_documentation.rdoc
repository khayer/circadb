...
This documentation will give you a quick overview on how you can include your own datasets. It will also describe some of the main features provided by this application.
...
4.  Move your prepared datasets into _/seed_data_

4.  Before the dataset can be added with _rake seed:add_data_ , we will need to take a look at _/lib/tasks/seed.rake_.
