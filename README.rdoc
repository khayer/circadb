...
Welcome to the CIRCA project. This is a data set of time course series data, highlighting circadian gene expression cycles through the use of the Cosopt algorithm for determining rhythmicity.
...
Example prepare script can be found in <em>/prepare_data_scripts</em>.
